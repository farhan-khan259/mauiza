...
const approach = [
  [
    BookMarked,
    "Understanding",
    "Build a strong foundation and develop a meaningful understanding of what you learn.",
  ],
  [
    Target,
    "Practice",
    "Encourage students to apply their learning consistently in everyday life.",
  ],
  [
    Lightbulb,
    "Consistency",
    "Small, regular learning efforts can create lasting progress.",
  ],
  [
    Users,
    "Guidance",
    "Learn with structured instruction and support throughout your journey.",
  ],
  [
    ShieldCheck,
    "Accessibility",
    "Make learning possible from home through a convenient online environment.",
  ],
];
const values = [
  ["Knowledge", "We value authentic and meaningful Islamic learning."],
  [
    "Excellence",
    "We strive to maintain a professional and organized learning experience.",
  ],
  [
    "Accessibility",
    "We believe Quranic education should be accessible to learners wherever they are.",
  ],
  [
    "Respect",
    "We create a welcoming environment for students from different backgrounds.",
  ],
  [
    "Consistency",
    "We encourage students to make learning a regular part of their lives.",
  ],
];
      ...
      <section className="section">
        <div className="container">
          <SectionHeading
            ...
            description="We believe effective Islamic education is more than simply completing lessons."
          />
          <div className="approach-grid">
            {approach.map(([icon, t, d], i) => (
              <FeatureCard key={t} icon={icon} title={t} index={i}>
                {d}
              </FeatureCard>
            ))}
          </div>
